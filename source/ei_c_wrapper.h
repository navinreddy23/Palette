/**
 * Credits to the author zst123
 * https://github.com/zst123/Element14_Low-Power-IoT/blob/master/low_power_iot/source/ei-library/ei_c_wrapper.h
 */
...
#define EI_CLASSIFIER_LABEL_COUNT (4) // From model_metadata.h
